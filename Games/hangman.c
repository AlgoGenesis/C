...
#include <ctype.h> /// for main() - tolower() used
#include <stdio.h> /// for main(), new_word(), new_guess(), won() used for I/O operations
#include <stdlib.h> /// for all functions - exit(), rand() and file functions
#include <string.h> /// for main() used for string operations strlen, strchr, strcpy
