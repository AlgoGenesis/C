// Implementation of a program in C to insert a node at a specific position in a doubly linked list
...
int main() {
    ...
    // Insert elements at specific positions in the doubly linked list
