...
// Function that implements Dijkstra's algorithm for a graph represented by an adjacency matrix
...
int main() {
    ...
    dijkstra(graph, 0); // Call Dijkstra's algorithm with 0 as the source vertex
